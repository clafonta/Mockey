...
/**
 * Accepts requests for "who hit this service" and returns HTML format. Servlet
 * does not forward data to a JSP, instead produces content to display inline
 * with HTML/JSP. Consumer of this servlet is an AJAX call.
 * 
 */
public class MockHistoryHtmlServlet extends HttpServlet {
