...
public class RequestResponseTransaction implements Item {
    ...
    private Long id;
    private MockServiceScenarioBean serviceInfo;
    ...
    public MockServiceScenarioBean getServiceInfo() {
        return serviceInfo;
    }

    public void setServiceInfo(MockServiceScenarioBean serviceInfo) {
