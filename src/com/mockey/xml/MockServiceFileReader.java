...
public class MockServiceFileReader {
	 ...
	 * @return
	 */
	public MockServiceStore readDefinition(String mockServicesDefinition) throws org.xml.sax.SAXParseException,
	...
	public static void main(String[] args) throws Exception {
		...
		MockServiceStore mockServiceList = fileReader.readDefinition(strXMLRequest);
