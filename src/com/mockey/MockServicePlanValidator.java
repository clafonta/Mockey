 ...
 *
 */
public class MockServicePlanValidator {
    /** Basic logger */
    private static Logger logger = Logger.getLogger(MockServicePlanValidator.class);
     ...
     * @return
     */
    public static Map validate(MockServicePlan ms) {
