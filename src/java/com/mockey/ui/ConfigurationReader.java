...
public class ConfigurationReader {
     ...
     * @throws IOException
     */
    public ConfigurationReadResults loadConfiguration(byte[] data) throws IOException {
        ...
        try {
            ...
            if (store.getUniversalErrorScenario() != null
                ...
                readResults.addConflictMsg("<b>Universal error message</b>: one already defined with name '"
                ...
                readResults.addAdditionMsg("<b>Universal error response defined.</b>");
            ...
            while (iter2.hasNext()) {
                ...
                while (iter3.hasNext()) {
                    ...
                    if (inMemoryServiceBean.getMockServiceUrl().equals(uploadedServiceBean.getMockServiceUrl())) {
                        ...
                        readResults.addConflictMsg("<b>Service not added</b>: Matching mock URL '"
                ...
                if (!existingServiceWithMatchingMockUrl) {
                    ...
                    readResults.addAdditionMsg("<b>Service Added</b>: '" + uploadedServiceBean.getServiceName() + "'");
                    ...
                    while (uIter.hasNext()) {
                        ...
                        if (!existingScenario) {
                            ...
                            readResults.addConflictMsg("<b>Scenario not added</b>: '" + mBean.getScenarioName()
            ...
            // PLANS
            List<ServicePlan> servicePlans = mockServiceStoreTemporary.getServicePlans();
            ...
            logger.debug("Unable to parse file", e);
            readResults.addConflictMsg("Unable to parse file");
