...
public interface ServicePlanConfigurationAPI {
	...
	public static final String API_SETPLAN_PARAMETER_PLAN_ID = "plan_id";
	public static final String API_SETPLAN_PARAMETER_ACTION_VALUE_DELETE_PLAN = "delete_plan";
	public static final String API_SETPLAN_PARAMETER_ACTION_VALUE_SAVE_PLAN = "save_plan";
	public static final String API_SETPLAN_PARAMETER_ACTION_VALUE_SET_PLAN = "set_plan";
